...
| Database name    	| books        	|               	|          	|               	|          	|               	|
|------------------	|--------------	|---------------	|----------	|---------------	|----------	|---------------	|
| Collections name 	| bookInfo     	|               	| users    	|               	| comments 	|               	|
|                  	| _id          	| autogenerated 	| _id      	| autogenerated 	| _id      	| autogenerated 	|
|                  	| title        	| string        	| username 	| string        	| title    	| string        	|
|                  	| author_fname 	| string        	| password 	| string        	| comment  	| string        	|
|                  	| author_sname 	| string        	|          	|               	| username 	| string        	|
|                  	| genre        	| string        	|          	|               	|          	|               	|
|                  	| year         	| Int32         	|          	|               	|          	|               	|
|                  	| synopsis     	| string        	|          	|               	|          	|               	|
